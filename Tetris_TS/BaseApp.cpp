...
void BaseApp::SetChar(int x, int y, wchar_t c)
{
	...
	mChiBuffer[x + (X_SIZE+1)*y].Attributes = FOREGROUND_GREEN | FOREGROUND_BLUE | FOREGROUND_RED | BACKGROUND_BLUE | BACKGROUND_INTENSITY | COMMON_LVB_REVERSE_VIDEO; // custom colors by @mrsarayra
}
